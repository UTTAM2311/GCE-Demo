...
public class SwaggerDocumentationConfig {
     ...
     */
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("GCE-Demo Application").description("").license("Apache 2.0")
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.example.demo")).build().useDefaultResponseMessages(false)
